...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="row">
                ...
                <form role="form" action="Addmember" method="post">
  ...
  <div class="form-group">
   ...
   <div class="col-sm-8">
    <input type="text" class="form-control" name="id" placeholder="Jane Doe">
  </div>
  <div class="col-sm-1">
  &nbsp;&nbsp;&nbsp;
	...
	$(document).ready(function(){
		$.getJSON("Member",function(data){
			...
			for (var i=0; i < data.length; i++) {
				...
				html += "<td>" +"<form role='form' action='bmodify.jsp?id="+data[i].id+"' method='post'><button type='submit' class='btn btn-danger'>修改</button></form>" + "</td>";
				html += "<td>" +"<form role='form' action='Delete?id="+data[i].id+"' method='post'><button type='submit' class='btn btn-danger'>删除</button></form>" + "</td></tr>";
