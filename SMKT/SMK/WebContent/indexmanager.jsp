...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<form class="form-horizontal templatemo-contact-form-1" role="form" action="News" method="post">
		        ...
		        <div class="form-group">
		          <div class="col-md-12">		          	
		            ...
		            <div class="templatemo-input-icon-container">
		            	...
		            	<input type="text" class="form-control" name="name" placeholder="发布者">
		            </div>		            		            		            
		          </div>              
		        </div>
		        ...
		        <div class="form-group">
		          <div class="col-md-12">
		            ...
		            <div class="templatemo-input-icon-container">
		            	...
		            	<textarea rows="8" cols="50" class="form-control" name="message" >message</textarea>
		            </div>
		          </div>
		        </div>
		        ...
		        <div class="form-group">
		          <div class="col-md-12">
		            <input type="submit" value="更新发布" class="btn btn-danger pull-right">
		          </div>
		        </div>		    	
		      </form>		 
	...
	$(document).ready(function(){
		$.getJSON("Seenews",function(data){
			...
			for (var i=0; i < data.length; i++) {
				...
				html += "<td>" +"<form role='form' action='newsdetail.jsp?id="+data[i].id+"' method='post'><button type='submit' class='btn btn-danger'>详情</button></form>" + "</td>";
				html += "<td>" +"<form role='form' action='Deletenews?id="+data[i].id+"' method='post'><button type='submit' class='btn btn-danger'>删除</button></form>" + "</td></tr>";
