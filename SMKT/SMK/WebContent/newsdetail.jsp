...
<body class="page-header-fixed">
	...
	<div class="page-container">
    	...
    	String state=null;
			...
			<form class="form-horizontal templatemo-contact-form-1" role="form"  method="post">
				...
				<div class="form-group">
		          <div class="col-md-12">
		            ...
		            <div class="templatemo-input-icon-container">
		            	...
		            	<input type="text" class="form-control" name="subject" value="<%= rs.getString("subject")%>" readonly>
		            </div>
		          </div>
		        </div>
		        ...
		        <div class="form-group">
		          <div class="col-md-12">		          	
		            ...
		            <div class="templatemo-input-icon-container">
		            	...
		            	<input type="text" class="form-control" name="name" value="<%= rs.getString("name")%>"readonly>
		            </div>		            		            		            
		          </div>              
		        </div>
		        <div class="form-group">
		        ...
		        <div class="form-group">
		          <div class="col-md-12">
		            ...
		            <div class="templatemo-input-icon-container">
		            	...
		            	<textarea rows="8" cols="50" class="form-control" name="message" readonly><%= rs.getString("message")%></textarea>
		            </div>
		          </div>
		        </div>
		        ...
		        <div class="form-group">
		          <div class="col-md-12">
		            <a class="btn btn-danger" href="indexmanager.jsp">返回</a>
		          </div>
		        </div>		    	
		      </form>		 
